  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl glass p-5 shadow-2xl data-[state=open]:animate-slide-up",
        className,
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 text-ink-muted hover:text-ink transition">
        <X size={16} />
...
export const DialogHeader = ({ className, ...p }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("space-y-1 mb-4", className)} {...p} />
);
